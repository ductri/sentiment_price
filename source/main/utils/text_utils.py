    ...
    with codecs.open(in_path, 'r', encoding='utf-8') as in_file,\
        ...
        for line in in_file:
            ...
            try:
                ...
                logging.error('Line with decode error: \n%s', e)
...
#     ids2 = get_ids(file2)
#
#     logging.info('ids in %s but not in %s:', file1, file2)
#     logging.info(ids1 - ids2)
#     logging.info('ids in %s but not in %s:', file2, file1)
#     logging.info(ids2 - ids1)
