...
class Baseline(nn.Module):
    def __init__(self, src_word_vocab_size, tgt_word_vocab_size):
        ...
        self.input_embedding = nn.Embedding(num_embeddings=src_word_vocab_size, embedding_dim=512)
        ...
        self.conv4 = nn.Conv1d(in_channels=512 + 512, out_channels=512, kernel_size=3, padding=1)
        ...
        self.fc = nn.Linear(in_features=256, out_features=tgt_word_vocab_size)
    ...
    def forward(self, input_word, *params):
        ...
        # shape == (batch_size, 512+512, max_word_len)
        ...
        # shape == (batch_size, max_word_len, 512)
        pipe = pipe.permute(0, 2, 1)
